...
const Posts = ({ post }) => {
  ...
  return (
    <div id={post.id} className="card post-card" style={{ width: "30rem" }}>
      <img src="../assets/no-image.jpg" className="card-img-top" alt="..." />
      <div className="card-body">
        ...
        <div className="alert alert-success reactions" role="alert">
          This post has been reacted by <span className="badge rounded-pill bg-info">{post.reactions}</span> people.
        </div>
      </div>
    </div>
  );
